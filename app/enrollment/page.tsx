...
export const metadata: Metadata = {
  title: "Enroll Your Child | Junior Padel Lessons Pretoria & Gauteng",
  description:
    "Enrol your child in NextGen Padel Academy today. Choose a package, select your nearest club or school in Pretoria or Gauteng, and start your padel journey.",
  alternates: { canonical: "https://nextgenpadel.co.za/enrollment" },
  openGraph: {
    title: "Enrol in Padel Lessons | NextGen Padel Academy Pretoria",
    description:
      "Simple online enrolment for kids padel coaching in Pretoria, Centurion, Midrand and Gauteng. Ages 4–17. Qualified coaches. Sign up today.",
    ...
    <main>
      <section className="bg-navy px-4 py-12 text-center text-navy-foreground sm:py-14">
        ...
        <h1 className="text-balance text-3xl font-black sm:text-5xl">
          Enrol in Junior Padel Lessons in Pretoria &amp; Gauteng
        </h1>
        <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-navy-foreground/80 sm:text-base">
          Choose your package, select your nearest club or school in Pretoria, Centurion, Midrand or across Gauteng, and give your child the opportunity to learn padel in a fun, safe environment. Ages 4–17.
        </p>
      </section>
